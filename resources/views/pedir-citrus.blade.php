    ...
    <div class="container-fluid fondo-inicio">
        ...
        <div class="container-sm">
            ...
            <div class="flecha-volver">
                <a href="citrus"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="white" class="bi bi-arrow-left-circle " viewBox="0 0 16 16">
        ...
        <div class="card-body">
            ...
            <div class="subtitle">
                <table>
                    <tbody>
                        <tr>
                            <td class="separador-derecho">Llevas <b>1<br> Bolsón Citrus</b></td>
                ...
                <hr class="line">
                <a class="btn btn-orange text-light rounded-pill pedido" href="formPedido?bolson=2">confirmar pedido</a>
            </div>
            </p>
        </div>
    </div>
