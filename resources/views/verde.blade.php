    ...
    <div class="card card-center mx-auto" style="width:  30rem;">
      ...
      <div class="card-body">
        ...
        <div class="row align-items-start">
          ...
          <div class="col-4">
            <a class="card-pedir" href="pedir-verde">pedir <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
        ...
        <div class="subtitle">
          <table>
            <tbody>
              <tr>
                <td class="separador-derecho">Lechuga</td>
                <td>1 kg aprox</td>
              </tr>
              <tr>
                <td class="separador-derecho">Rabanito</td>
                <td>2 kg aprox</td>
              </tr>
              <tr>
                <td class="separador-derecho">Cebollita</td>
                <td>1 kg aprox</td>
              </tr>
              <tr>
                <td class="separador-derecho">Palta</td>
                <td>1 kg aprox</td>
              </tr>
              <tr>
              ...
              <tr>
                <td class="separador-derecho">Perejil</td>
                <td>500 gr aprox</td>
              </tr>
            </tbody>
          </table>
